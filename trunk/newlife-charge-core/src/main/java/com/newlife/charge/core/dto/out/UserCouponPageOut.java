...
public class UserCouponPageOut {
    ...
    public String getTypeName() {
        if(this.type == null){
            return typeName;
        }else if(CouponTypeEnum.Charge_Type.getValue() == this.type) {
            typeName = "通用";

        }else if(CouponTypeEnum.Electro_Type.getValue() == this.type) {
            if(CouponScopeTypeEnum.All_Scope.getValue() == this.scopeType){
                typeName = "通用";
            }else {
                typeName = "部分桩站可用";
            }
        }else if(CouponTypeEnum.Station_Electro_Type.getValue() == this.type) {
            typeName = "部分桩站可用";
